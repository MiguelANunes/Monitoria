...
%%\textcolor{red}{alterei estas duas}
\begin{description}
\setlength{\itemsep}{-2pt}
 \item [1.]  $( p \wedge q \rightarrow q )~  \wedge~   (\sim q \rightarrow \sim p \wedge q)~   \wedge~   q $
 \item [2.]  $(\sim p \rightarrow \:\: \sim q \wedge p)~  \vee~  (q \wedge p \rightarrow p)~   \vee~  p$
\end{description}
...
%\textcolor{red}{NAO MODIFICADA da 3a prova ... poucos acertaram}
...
%\textcolor{red}{NAO MODIFICADA da prova ...ninguem acertou corretamente}
