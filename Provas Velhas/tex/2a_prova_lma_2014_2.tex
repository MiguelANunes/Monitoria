...
\begin{flushright}
``O segredo do sucesso é a consistência do propósito.''\\{\footnotesize  Benjamin Disraeli}
\end{flushright}
...
\item $\{ r \rightarrow t, \:\:  s \rightarrow q, \:\: 
t \vee q \rightarrow \sim p, \:\:  r \vee s \}$ {\bf $\vdash $} $ \sim p$
 %% pagina 126 -- m
