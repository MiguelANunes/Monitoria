...
\begin{flushright}
``A educação é a arma mais poderosa que você pode usar para mudar o mundo.''\\{\footnotesize  Nelson Mandela}
\end{flushright}


\vskip 0.5cm Acad\^emico(a) : \rule{10cm}{0.4pt} Turma:  $\frac{[ ~~ ] ~ T_A - Rogerio}{[ ~~ ] ~ T_B - Claudio}$ 
\noindent
