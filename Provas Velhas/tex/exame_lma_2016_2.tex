...
\begin{description}
\setlength{\itemsep}{-2pt}
 \item [1.]  $( p \rightarrow q) \vee  (\sim q \rightarrow \sim p) \wedge q $
 \item [2.]  $(\sim p \rightarrow \:\: \sim q) \vee (q \rightarrow p) \wedge p $
\end{description}
...
%\textcolor{red}{Rogerio ... esta questao eh MUITO BOA ... poucos acertaram podemos repetir sem problemas}

\item {\bf (1.0 pt)} Dado os programas em lógica da questão anterior, reescreva-o o seu equivalente
em LPO com todas as fórmulas %\textbf{\textcolor{red}{ACHO ESTA uma questao MUITO PEDAGOGICA}}
